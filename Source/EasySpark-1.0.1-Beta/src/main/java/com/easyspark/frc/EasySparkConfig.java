...
public record EasySparkConfig(int id, String name, EasySparkControllerInfo escInfo, CANcoder CANcoder, DutyCycleEncoder DutyCycleEncoder) {
    ...
    // USES CONSTANTS INSTEAD OF ESCINFO
     ...
     * @param id The ID used by the SparkMax on the CAN bus.
     * @param name The name given for the motor/subsystem.
     * @param constants This is the info used to create a SparkMax instance.
     * @param CANcoder A CANcoder object. Set to null by default.
     * @param DutyCycleEncoder An Absolute Encoder. Set to null by default.
     * 
     * @see EasySpark
     * @see EasySparkConstants
     */
    public EasySparkConfig(int id, String name, EasySparkConstants constants) {
        this(id, name, new EasySparkControllerInfo(constants), null, null);
    }
     ...
     * @see EasySparkConstants
     */
    public EasySparkConfig(int id, String name, EasySparkConstants constants, DutyCycleEncoder DutyCycleEncoder) {
        this(id, name, new EasySparkControllerInfo(constants), null, DutyCycleEncoder);
    }
     ...
     * @see EasySparkConstants
     */
    public EasySparkConfig(int id, String name, EasySparkConstants constants, CANcoder CANcoder) {
        this(id, name, new EasySparkControllerInfo(constants), CANcoder, null);
    }
     ...
     * @see EasySparkConstants
     */
    public EasySparkConfig(int id, String name, EasySparkConstants constants, CANcoder CANcoder, DutyCycleEncoder DutyCycleEncoder) {
        this(id, name, new EasySparkControllerInfo(constants), CANcoder, DutyCycleEncoder);
    }
